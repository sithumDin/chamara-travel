...
export const tours: Tour[] = [
  {
    ...
    images: [
      { src: "/gallery/colombo-skyline-twilight-lake.jpg", alt: "Colombo skyline at twilight reflected on the lake" },
      { src: "/gallery/gangaramaya-temple-buddha-statues.jpg", alt: "Buddha statues at Gangaramaya Temple in Colombo" },
      { src: "/gallery/galle-face-green-promenade.jpg", alt: "Galle Face Green promenade on the Colombo seafront" },
  ...
  },
  {
    ...
    images: [
      ...
      { src: "/gallery/dambulla-cave-temple-seated-buddhas-row.jpg", alt: "Row of seated Buddha statues at Dambulla cave temple" },
      { src: "/gallery/woman-sigiriya-lion-staircase-view.jpg", alt: "Woman at the Sigiriya lion staircase view" },
      { src: "/gallery/woman-sigiriya-rock-garden-view.jpg", alt: "Woman with a garden view of Sigiriya rock" },
      { src: "/gallery/woman-sigiriya-rock-ruins-portrait.jpg", alt: "Woman portrait among the Sigiriya rock ruins" },
      { src: "/gallery/dambulla-cave-temple-golden-buddha.jpg", alt: "Golden Buddha statue at Dambulla cave temple" },
      { src: "/gallery/reclining-buddha-cave-temple-statue.jpg", alt: "Reclining Buddha statue in a cave temple" },
    ],
    durationDays: 1,
    durationLabel: "1 Day",
    themes: ["culture"],
  ...
  },
  {
    ...
    images: [
      { src: "/gallery/ruwanwelisaya-stupa-anuradhapura.jpg", alt: "The Ruwanwelisaya stupa in Anuradhapura framed by tree branches" },
      ...
      { src: "/gallery/family-polonnaruwa-royal-palace-ruins.jpg", alt: "Family at the Polonnaruwa royal palace ruins" },
      { src: "/gallery/polonnaruwa-vatadage-buddha-statue.jpg", alt: "Buddha statue at the Polonnaruwa Vatadage" },
      { src: "/gallery/men-bathing-elephants-river.jpg", alt: "Men bathing elephants in the river" },
      { src: "/gallery/couple-sigiriya-rock-field-portrait.jpg", alt: "Couple portrait in the field at Sigiriya rock" },
      { src: "/gallery/standing-buddha-statue-palm-trees.jpg", alt: "Standing Buddha statue framed by palm trees" },
    ],
    durationDays: 4,
  ...
  },
  {
    ...
    images: [
      ...
      { src: "/gallery/elephant-crossing-forest-track.jpg", alt: "Wild elephant crossing a forest dirt track" },
      { src: "/gallery/114-couple-safari-jeep-portrait.jpg", alt: "Guests on a safari jeep during a Yala game drive" },
      { src: "/gallery/peacock-feathers-display.jpg", alt: "Peacock displaying its vibrant feathers" },
      { src: "/gallery/guide-guest-yala-national-park-sign.jpg", alt: "Guide and guest at the Yala National Park sign" },
      { src: "/gallery/sambar-deer-antlers-hillside.jpg", alt: "Sambar deer with antlers on a grassy hillside" },
      { src: "/gallery/orange-lizard-branch-closeup.jpg", alt: "Close-up of an orange lizard on a branch" },
      { src: "/gallery/woman-safari-jeep-portrait.jpg", alt: "Woman portrait in the safari jeep" },
      { src: "/gallery/couple-safari-truck-roadside-portrait.jpg", alt: "Couple portrait beside the safari truck" },
      { src: "/gallery/woman-photographing-wild-elephant-safari.jpg", alt: "Woman photographing a wild elephant on safari" },
      { src: "/gallery/kingfisher-bird-mangrove-branch.jpg", alt: "Kingfisher bird perched on a mangrove branch" },
    ],
    durationDays: 3,
  ...
  },
  {
    ...
    images: [
      ...
      { src: "/gallery/woman-nine-arches-bridge-portrait.jpg", alt: "Woman portrait at the Nine Arches Bridge" },
      { src: "/gallery/ella-train-station-foggy-morning.jpg", alt: "Foggy morning at Ella train station" },
    ],
    durationDays: 4,
    durationLabel: "4 Days / 3 Nights",
    themes: ["hill-country"],
  ...
  },
  {
    ...
    images: [
      ...
      { src: "/gallery/humpback-whale-tail-mirissa.jpg", alt: "Humpback whale tail breaking the ocean surface" },
      ...
      { src: "/gallery/galle-lighthouse-fort-pathway.jpg", alt: "Pathway leading to the Galle Fort lighthouse" },
      { src: "/gallery/parrot-rock-island-sunset-mirissa.jpg", alt: "Parrot Rock island at sunset in Mirissa" },
      { src: "/gallery/wet-sand-foam-wave-closeup.jpg", alt: "Close-up of wet sand and wave foam" },
    ],
    durationDays: 5,
  ...
  },
  {
    ...
    images: [
      { src: "/gallery/couple-beach-sunset-honeymoon.jpg", alt: "Couple sitting on the beach watching the sunset" },
      { src: "/gallery/private-villa-pool-sea-view.jpg", alt: "Private villa pool with a sea view" },
      { src: "/gallery/candlelit-dinner-romantic-evening.jpg", alt: "Candlelit dinner table set up for a romantic evening" },
      { src: "/gallery/013-guide-couple-tea-plantation-path.jpg", alt: "Couple walking through the tea plantation with their guide" },
      { src: "/gallery/couple-large-waterfall-rock-portrait.jpg", alt: "Couple portrait on a rock before a large waterfall" },
      { src: "/gallery/orange-sunset-clouds-beach-view.jpg", alt: "Orange sunset clouds over the beach" },
    ],
    durationDays: 7,
  ...
  },
  {
    ...
    images: [
      { src: "/gallery/white-water-rafting-rapids.jpg", alt: "White water rafting through river rapids" },
      { src: "/gallery/051-couple-hiking-forest-path-horton-plains.jpg", alt: "Hiking the forest trail at Horton Plains" },
      { src: "/gallery/ziplining-forest-canopy.jpg", alt: "Ziplining through the forest canopy" },
      { src: "/gallery/canyoning-waterfall-jump.jpg", alt: "Jumping into a waterfall pool while canyoning" },
      { src: "/gallery/women-group-canyoning-gear-portrait.jpg", alt: "Group of women in canyoning gear portrait" },
      { src: "/gallery/woman-canyoning-waterfall-celebration.jpg", alt: "Woman celebrating during a canyoning waterfall adventure" },
    ],
    durationDays: 6,
  ...
  },
  {
    ...
    images: [
      { src: "/gallery/aerial-drone-tangalle-beach.jpg", alt: "Aerial drone view of Tangalle beach on the Sri Lankan coastline" },
